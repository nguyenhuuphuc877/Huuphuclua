...
local Window = Fluent:CreateWindow({Title = "Nguyen Huu Phuc, Group zalo https://zalo.me/g/fvyqup314 ",SubTitle = "| ",TabWidth = 155,Size = UDim2.fromOffset(555, 320),Acrylic = false,Theme = "Dark",MinimizeKey = Enum.KeyCode.End})
local Tabs = {
...
ImageButton.Image = "rbxassetid://124640603600682"
...
if IsPc then
  if not string.find(executor, "Wave") or not string.find(executor, "AWP") then
    Fluent:Notify({Title = "Free Script",Content = "your executor isn't offically supported, you may experience bug or glitch",SubContent = "",Duration = 15})
  else
    Fluent:Notify({Title = "Free Script",Content = "",SubContent = "",Duration = 15})
  end
else
  Fluent:Notify({Title = "Free Script",Content = "",SubContent = "",Duration = 15})
end
